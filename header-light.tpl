...
<section id="header">
    <div class="container container">
        ...
        {else}
            <a href="{$WEB_ROOT}/index.php" class="navbar-brand"><img src="{$WEB_ROOT}/templates/{$template}/images/logo-dark.svg" alt="{$companyname}"></a>
        {/if}
    </div>
</section>
                        ...
                        <div class="row rtl-row">
                            <div class="col-sm-5">
                                <div class="img-holder">
                                    <img src="{$WEB_ROOT}/templates/{$template}/images/slide-img4.png" alt="">
                                </div>
                            </div>
                            <div class="col-sm-7">
                                        ...
                                        <div class="col-md-4">
                                            <span class="input-items-btn">
                                                {if $registerdomainenabled}
                                                    <input type="submit" class="hbtn hbtn-primary search{$captcha->getButtonClass($captchaForm)}" value="{$LANG.search}" />
                                                {/if}
                                            </span>
                                        </div>
                                    </div>
